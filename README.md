...
This repository contains the replication codes for the report "Confidence Intervals and Hypothesis Testing for High-Dimensional Regression: A Review and Discussion" by Benjamin Smith. For the report, see [here](https://github.com/phd-statistics/sta3000-report/blob/main/report.pdf). For the presentation slides, see [here](https://github.com/phd-statistics/sta3000-report/blob/main/presentation.pdf)
